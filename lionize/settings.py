"""
Django settings for lionize project.
...
ALLOWED_HOSTS = ['a80fede3bae5.ngrok.io', 'localhost']
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' #Log emails to the console for development
...
WSGI_APPLICATION = 'lionize.wsgi.application'
...
# DATABASES = {
#     'default': dj_database_url.parse(os.getenv('POSTGRES_DB_CONNECTION'))
# }
